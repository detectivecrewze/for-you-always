...
const testimonials = [
    {
        name: "Kak N*** (Verified)",
        product: "Letter Edition",
        text: "kakakk makasih ya udah bikin templates kayak ginii, aku ga expect pacarku sampe nangiss wkwk... sukses terus ya kakk usahanya, keren banget!!",
        rating: 5,
        delay: 80
    },
    {
        name: "Kak S*** (Verified)",
        product: "Voices Gift",
        text: "gada kak aman kok dia suka sekali... cayang ku sampe terharu nangis wkwkwk... tidur nyenyak yah minnn, bye bye",
        rating: 5,
        delay: 160
    },
    {
        ...
        text: "done kak, thank youu so much... sukaa banget respon nya cepet + tanggap bangett!",
        rating: 5,
        delay: 240
    },
    {
        name: "Kak M*** (Verified)",
        product: "Mixtape & Memoria",
        text: "asli bagus banget dan sesuai persis sama yg di tiktok... detailnya juga rapih banget, keliatan niat dan effortnya. definitely bakal order lagi!",
        rating: 5,
        delay: 320
    },
];
        ...
        <section id="testimoni" style={{ position: "relative", zIndex: 1, padding: "120px 0", background: "#1d1816", overflow: "hidden" }}>
            ...
            <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 clamp(16px, 4vw, 40px)", position: "relative", zIndex: 1 }}>
                <AnimatedSection>
                    <div style={{ textAlign: "center", marginBottom: 80 }}>
                        <span style={{
                            ...
                            color: "rgba(205,171,143,0.7)", display: "inline-block",
                            padding: "6px 20px", border: "1px solid rgba(205,171,143,0.25)",
                    ...
                    {testimonials.map((r, i) => (
                        <AnimatedSection key={i} delay={r.delay}>
                            <div style={{
                                ...
                                border: "1px solid rgba(205,171,143,0.12)",
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 12, paddingTop: 16, borderTop: "1px solid rgba(205,171,143,0.1)" }}>
                                    <div style={{ width: 32, height: 32, borderRadius: "50%", background: "rgba(205,171,143,0.12)", border: "1px solid rgba(205,171,143,0.2)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                                        <span style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontSize: 12, color: "#cdab8f", fontWeight: 700 }}>
                                            {r.name.charAt(4) || "P"}
                                        </span>
                                    </div>
                                    <div>
                                        <div style={{ fontFamily: "var(--font-sans)", fontSize: 12, fontWeight: 700, color: "#faf7f2", marginBottom: 2 }}>{r.name}</div>
                                        <div style={{ fontFamily: "var(--font-sans)", fontSize: 9, fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase" as const, color: "rgba(205,171,143,0.7)" }}>via {r.product}</div>
                                    </div>
                                </div>
                            </div>
                        </AnimatedSection>
                ...
                <AnimatedSection delay={400}>
                    <div style={{ marginTop: 70, display: "flex", justifyContent: "center", gap: "clamp(32px, 8vw, 100px)", flexWrap: "wrap" }}>
                        {stats.map((stat, i) => (
                            <div key={i} style={{ textAlign: "center" }}>
                                ...
                                <div style={{ fontFamily: "var(--font-sans)", fontSize: 9, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase" as const, color: "rgba(205,171,143,0.6)" }}>{stat.label}</div>
                            </div>
                        ))}
                    </div>

                    {/* Direct CTA Button to Wall of Love */}
                    <div style={{ textAlign: "center", marginTop: 50 }}>
                        ...
                        >
                            <span>Baca 20 Cerita &amp; Percakapan Nyata di Wall of Love</span>
                            <span>&rarr;</span>
                        </Link>
                    </div>
                </AnimatedSection>
