          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="flex-1 w-full">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Voices Edition Pricing Card */}
                <AnimatedSection delay={100}>
                  <div className="relative group h-full">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-100 to-orange-100 rounded-[2rem] blur-xl opacity-50 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
                    <div className="relative bg-white border border-slate-100 p-8 rounded-[2rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] h-full flex flex-col">
                      <div className="flex justify-between items-start mb-8">
                        <div>
                          <h3 className="text-lg font-bold text-slate-900 mb-1">Voices Edition</h3>
                          <p className="text-xs text-slate-400 italic">Foto & Pesan Suara</p>
                        </div>
                        <div className="px-3 py-1 bg-amber-50 rounded-lg text-[10px] font-bold text-amber-600 uppercase tracking-wider">
                          Harga Spesial
                        </div>
                      </div>
                      ...
                      <ul className="space-y-3 mb-8 flex-grow">
                        {[
                          ...
                          <li key={i} className="flex items-center gap-3 text-slate-600">
                            <div className="flex-shrink-0 w-4 h-4 rounded-full bg-amber-50 border border-amber-100 flex items-center justify-center">
                      ...
                      <a
                        ...
                        className="flex items-center justify-center w-full py-4 bg-amber-500 text-white font-bold rounded-2xl
                          transition-all duration-500 hover:bg-amber-600 hover:shadow-xl hover:shadow-amber-100 gap-2 text-sm"
                      >
                        Pesan Voices
                ...
                {/* Premium Themes Pricing Card */}
                <AnimatedSection delay={200}>
                  <div className="relative group h-full">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-rose-100 to-indigo-100 rounded-[2rem] blur-xl opacity-50 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
                    <div className="relative bg-white border border-slate-100 p-8 rounded-[2rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] h-full flex flex-col">
                      <div className="flex justify-between items-start mb-8">
                        <div>
                          <h3 className="text-lg font-bold text-slate-900 mb-1">Pass-Key Tema</h3>
                          <p className="text-xs text-slate-400 italic">Unlimited Customization</p>
                        </div>
                      ...
                      <div className="flex flex-col gap-1 mb-8">
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-bold text-slate-300 line-through decoration-rose-400/30">Rp 30.000</span>
                          <span className="px-2 py-0.5 bg-rose-500 text-[9px] font-black text-white rounded-md uppercase tracking-tighter">Hemat 33%</span>
                        </div>
                        <div className="flex items-baseline gap-1.5">
                          <span className="text-lg font-display font-medium text-slate-400">Rp</span>
                          <span className="text-5xl font-display font-bold text-slate-900 tracking-tighter">20.<span className="text-2xl">000</span></span>
                      ...
                      <ul className="space-y-3 mb-8 flex-grow">
                        {[
                          ...
                          <li key={i} className="flex items-center gap-3 text-slate-600">
                            <div className="flex-shrink-0 w-4 h-4 rounded-full bg-rose-50 border border-rose-100 flex items-center justify-center">
                      ...
                      <a
                        ...
                        className="flex items-center justify-center w-full py-4 bg-slate-900 text-white font-bold rounded-2xl
                          transition-all duration-500 hover:bg-rose-600 hover:shadow-xl hover:shadow-rose-100 gap-2 text-sm"
                      >
                        Dapatkan Akses
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
